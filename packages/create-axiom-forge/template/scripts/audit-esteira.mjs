...
const IGNORE_DIRS = new Set([
  ...
  // Cada squad mantém seu próprio dialeto/documentação e seus gates locais.
  // A auditoria da raiz cobre apenas a camada cross-squad.
  "product", "frontend", "backend",
  // O pacote npm é um artefato de distribuição; seus templates têm o próprio
  // contrato de geração e não são documentação operacional da raiz.
  "packages",
]);
