...
// Providers são descritos por seus formatos de projeto documentados. A CLI usa
// este catálogo para oferecer seleção múltipla e escolher o adapter correto.
export const AGENT_PROVIDERS = deepFreeze([
  {
    value: "claude",
    label: "Claude Code",
    description: "agentes, skills, regras e hooks para o Claude Code",
    artifact: "agentes + Agent Skills",
    paths: [".claude/agents", ".claude/skills"],
    supports: { customAgent: true, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://code.claude.com/docs/en/skills", "https://code.claude.com/docs/en/sub-agents"],
  },
  {
    value: "codex",
    label: "Codex",
    description: "AGENTS.md e Agent Skills para o Codex",
    artifact: "AGENTS.md + Agent Skills",
    paths: ["AGENTS.md", ".agents/skills"],
    supports: { customAgent: false, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://github.com/openai/codex/blob/main/docs/agents_md.md"],
  },
  {
    value: "copilot",
    label: "GitHub Copilot",
    description: "custom agents, instruções de repositório e skills do Copilot",
    artifact: "custom agents + Agent Skills",
    paths: [".github/agents", ".github/skills", ".github/copilot-instructions.md"],
    supports: { customAgent: true, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://docs.github.com/en/copilot/reference/customization-cheat-sheet", "https://docs.github.com/en/copilot/how-tos/copilot-on-github/customize-copilot/customize-cloud-agent/add-skills"],
  },
  {
    value: "cursor",
    label: "Cursor",
    description: "regras MDC e instruções compartilhadas para o Cursor",
    artifact: "Project Rules",
    paths: [".cursor/rules", "AGENTS.md"],
    supports: { customAgent: false, skills: false, rules: true, workflows: false, instructions: true },
    sources: ["https://docs.cursor.com/context/rules-for-ai"],
  },
  {
    value: "windsurf",
    label: "Windsurf",
    description: "skills, regras e workflows para o Cascade",
    artifact: "Agent Skills + Rules",
    paths: [".windsurf/skills", ".windsurf/rules", ".windsurf/workflows"],
    supports: { customAgent: false, skills: true, rules: true, workflows: true, instructions: true },
    sources: ["https://docs.windsurf.com/windsurf/cascade/skills", "https://docs.windsurf.com/windsurf/cascade/memories"],
  },
  {
    value: "kimi",
    label: "Kimi Code",
    description: "custom agents e Agent Skills para o Kimi Code",
    artifact: "custom agents + Agent Skills",
    paths: [".kimi-code/agents", ".kimi/skills"],
    supports: { customAgent: true, skills: true, rules: false, workflows: false, instructions: true },
    sources: ["https://moonshotai.github.io/kimi-cli/en/customization/agents.html", "https://moonshotai.github.io/kimi-cli/en/customization/skills.html"],
  },
  {
    value: "antigravity",
    label: "Google Antigravity",
    description: "Agent Skills, regras e workflows do Antigravity",
    artifact: "Agent Skills + Rules + Workflows",
    paths: [".agents/skills", ".agents/rules", ".agents/workflows"],
    supports: { customAgent: false, skills: true, rules: true, workflows: true, instructions: true },
    sources: ["https://antigravity.google/docs/skills?app=antigravity-ide", "https://antigravity.google/docs/rules-workflows?app=antigravity"],
  },
  {
    value: "gemini",
    label: "Gemini CLI",
    description: "GEMINI.md, Agent Skills e comandos do Gemini CLI",
    artifact: "GEMINI.md + Agent Skills",
    paths: ["GEMINI.md", ".gemini/skills", ".gemini/commands"],
    supports: { customAgent: false, skills: true, rules: true, workflows: true, instructions: true },
    sources: ["https://google-gemini.github.io/gemini-cli/docs/cli/using-agent-skills.html", "https://google-gemini.github.io/gemini-cli/docs/cli/gemini-md.html"],
  },
  {
    value: "cline",
    label: "Cline",
    description: "regras e Agent Skills para o Cline",
    artifact: "Agent Skills + rules",
    paths: [".cline/skills", ".clinerules"],
    supports: { customAgent: false, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://docs.cline.bot/customization/skills", "https://docs.cline.bot/customization/cline-rules"],
  },
  {
    value: "roo",
    label: "Roo Code",
    description: "custom mode e regras de projeto para o Roo Code",
    artifact: "custom mode + rules",
    paths: [".roomodes", ".roo/rules"],
    supports: { customAgent: true, skills: false, rules: true, workflows: false, instructions: true },
    sources: ["https://docs.roocode.com/features/custom-modes", "https://docs.roocode.com/features/custom-instructions"],
  },
  {
    value: "kiro",
    label: "Kiro",
    description: "custom agents, steering e Agent Skills para o Kiro",
    artifact: "custom agents + steering + Agent Skills",
    paths: [".kiro/agents", ".kiro/steering", ".kiro/skills"],
    supports: { customAgent: true, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://kiro.dev/docs/cli/custom-agents/creating/", "https://kiro.dev/docs/skills/", "https://kiro.dev/docs/steering/"],
  },
  {
    value: "amazon-q",
    label: "Amazon Q Developer",
    description: "regras de projeto para o Amazon Q Developer",
    artifact: "project rules",
    paths: [".amazonq/rules"],
    supports: { customAgent: false, skills: false, rules: true, workflows: false, instructions: true },
    sources: ["https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/context-project-rules.html"],
  },
  {
    value: "continue",
    label: "Continue",
    description: "regras locais para Agent, Chat e Edit do Continue",
    artifact: "local rules",
    paths: [".continue/rules"],
    supports: { customAgent: false, skills: false, rules: true, workflows: false, instructions: false },
    sources: ["https://docs.continue.dev/customize/rules", "https://docs.continue.dev/reference"],
  },
  {
    value: "opencode",
    label: "OpenCode",
    description: "AGENTS.md e Agent Skills nativos do OpenCode",
    artifact: "AGENTS.md + Agent Skills",
    paths: ["AGENTS.md", ".opencode/skills"],
    supports: { customAgent: false, skills: true, rules: true, workflows: false, instructions: true },
    sources: ["https://opencode.ai/docs/instructions", "https://opencode.ai/docs/skills"],
  },
]);

export const OPTION_GUIDANCE = deepFreeze({
  agents: {
    claude: { what: "Instala agentes especialistas, skills, regras e hooks para Claude Code.", when: "Marque se Claude Code fará parte do seu fluxo de desenvolvimento.", tradeoff: "Cria arquivos nativos em .claude, além do conteúdo técnico compartilhado.", recommended: "Uma das duas escolhas recomendadas para começar." },
    codex: { what: "Instala AGENTS.md e skills para orientar o Codex no projeto.", when: "Marque se Codex fará parte do seu fluxo de desenvolvimento.", tradeoff: "Usa a convenção AGENTS.md e .agents/skills, sem criar agentes nativos separados.", recommended: "Uma das duas escolhas recomendadas para começar." },
    copilot: { what: "Instala custom agents, skills e instruções que o GitHub Copilot reconhece no repositório.", when: "Marque se o time usa Copilot no GitHub, no editor ou na linha de comando.", tradeoff: "O Copilot tem superfícies diferentes, então algumas funções dependem do produto usado.", recommended: "Boa escolha quando o repositório já vive no GitHub." },
    cursor: { what: "Instala regras MDC em .cursor/rules para o Cursor aplicar ao código.", when: "Marque se o Cursor é o editor principal do projeto.", tradeoff: "Cursor não documenta uma pasta equivalente a agentes customizados, por isso o adapter usa regras e AGENTS.md.", recommended: "Boa escolha para um fluxo centrado no editor Cursor." },
    windsurf: { what: "Instala Agent Skills, regras e um workflow de kickoff para o Cascade.", when: "Marque se você trabalha no Windsurf ou no Cascade.", tradeoff: "Regras e workflows têm formas diferentes de ativação, então a CLI separa cada tipo de arquivo.", recommended: "Boa escolha para quem quer skills com carregamento sob demanda." },
    kimi: { what: "Instala custom agents e Agent Skills para Kimi Code.", when: "Marque se Kimi será usado para executar tarefas especializadas.", tradeoff: "Os agentes são arquivos Markdown nativos e as skills ficam em .kimi/skills.", recommended: "Boa escolha para equipes que alternam providers por tarefa." },
    antigravity: { what: "Instala Agent Skills, regras e workflows na estrutura .agents do Antigravity.", when: "Marque se você usa Google Antigravity como ambiente de desenvolvimento.", tradeoff: "Antigravity trabalha com regras e workflows, não com uma pasta de agentes customizados.", recommended: "Boa escolha quando o time quer uma base compartilhada com outros agents." },
    gemini: { what: "Instala GEMINI.md e Agent Skills para o Gemini CLI.", when: "Marque se o Gemini CLI participará do trabalho no terminal.", tradeoff: "GEMINI.md é contexto hierárquico e skills são carregadas quando relevantes.", recommended: "Boa escolha para fluxos de terminal com contexto versionado." },
    cline: { what: "Instala Agent Skills e regras de projeto para o Cline.", when: "Marque se você usa Cline no editor.", tradeoff: "O Cline aplica regras e skills, sem um formato separado de agente no projeto.", recommended: "Boa escolha se o time já usa o ecossistema Agent Skills." },
    roo: { what: "Instala um custom mode e regras de projeto para o Roo Code.", when: "Marque se o Roo Code é usado no editor.", tradeoff: "O formato nativo é um modo selecionável, não um arquivo de agente independente.", recommended: "Boa escolha quando tarefas precisam de modos especializados." },
    kiro: { what: "Instala custom agents, steering e Agent Skills para o Kiro.", when: "Marque se o Kiro será usado para desenvolver o projeto.", tradeoff: "Steering e recursos do custom agent são arquivos separados e podem ser ajustados depois.", recommended: "Boa escolha para times que querem agentes configuráveis por projeto." },
    "amazon-q": { what: "Instala regras versionadas em .amazonq/rules para o Amazon Q Developer.", when: "Marque se o Amazon Q será usado no repositório.", tradeoff: "A documentação oficial do projeto confirma regras, não um formato universal de custom agent.", recommended: "Boa escolha para times que já operam na AWS." },
    continue: { what: "Instala regras locais para os modos Agent, Chat e Edit do Continue.", when: "Marque se o Continue será um dos clients do projeto.", tradeoff: "A configuração de modelos e tools continua sendo responsabilidade do ambiente Continue do usuário.", recommended: "Boa escolha quando o time mantém configuração de modelos fora do repositório." },
    opencode: { what: "Instala AGENTS.md e Agent Skills nativos do OpenCode.", when: "Marque se OpenCode será usado no terminal ou editor.", tradeoff: "OpenCode v2 usa AGENTS.md e skills, portanto não recebe um agente inventado em uma pasta própria.", recommended: "Boa escolha para combinar o padrão aberto com um client de terminal." },
  },
  mode: {
