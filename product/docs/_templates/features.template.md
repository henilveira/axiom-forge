...
|----|-----------------------|--------------|---------|-------|-----------|-------|------|
| 1  | <…>                   | <jornada>    | baixo   | alto  | alta      | média | 1    |
| 2  | <…>                   | <jornada>    | alto    | médio | baixa     | alta  | 2    |

## Sequenciador (ondas)
> Ordene por **valor × esforço**; comece pelo menor caminho que entrega e **valida** uma hipótese.

- **Onda 1 (MVP):** <funcionalidades> — *valida:* <hipótese>
- **Onda 2:** <funcionalidades>
- **Onda 3 / depois:** <funcionalidades>

> Os itens da **Onda 1** viram o `roadmap.md` (horizonte "Agora") e specs via `spec-engineer`.
